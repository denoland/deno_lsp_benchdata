import type { EndpointOptions, RequestParameters, Route, RequestInterface, OctokitResponse } from "https://esm.sh/v135/@octokit/types@12.3.0/dist-types/index.d.ts";
import * as AuthOAuthUser from "https://esm.sh/v135/@octokit/auth-oauth-user@4.0.1/dist-types/index.d.ts";
import * as DeviceTypes from "https://esm.sh/v135/@octokit/auth-oauth-device@6.0.1/dist-types/index.d.ts";
