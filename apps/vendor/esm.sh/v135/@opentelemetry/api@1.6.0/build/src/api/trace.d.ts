import { isSpanContextValid, wrapSpanContext } from '../trace/spancontext-utils.d.ts';
import { Tracer } from '../trace/tracer.d.ts';
import { TracerProvider } from '../trace/tracer_provider.d.ts';
import { deleteSpan, getActiveSpan, getSpan, getSpanContext, setSpan, setSpanContext } from '../trace/context-utils.d.ts';
/**
