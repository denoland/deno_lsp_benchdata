import { ExportResult, BindOnceFuture } from 'https://esm.sh/v135/@opentelemetry/core@1.17.0/build/src/index.d.ts';
import { OTLPExporterError, OTLPExporterConfigBase } from './types.d.ts';
/**
