...
import { AuthenticationV1TokenRequest } from '../model/authenticationV1TokenRequest.d.ts';
import { CoreV1Event } from '../model/coreV1Event.d.ts';
import { CoreV1EventList } from '../model/coreV1EventList.d.ts';
import { V1APIResourceList } from '../model/v1APIResourceList.d.ts';
import { V1Binding } from '../model/v1Binding.d.ts';
import { V1ComponentStatus } from '../model/v1ComponentStatus.d.ts';
import { V1ComponentStatusList } from '../model/v1ComponentStatusList.d.ts';
import { V1ConfigMap } from '../model/v1ConfigMap.d.ts';
import { V1ConfigMapList } from '../model/v1ConfigMapList.d.ts';
import { V1DeleteOptions } from '../model/v1DeleteOptions.d.ts';
import { V1Endpoints } from '../model/v1Endpoints.d.ts';
import { V1EndpointsList } from '../model/v1EndpointsList.d.ts';
import { V1Eviction } from '../model/v1Eviction.d.ts';
import { V1LimitRange } from '../model/v1LimitRange.d.ts';
import { V1LimitRangeList } from '../model/v1LimitRangeList.d.ts';
import { V1Namespace } from '../model/v1Namespace.d.ts';
import { V1NamespaceList } from '../model/v1NamespaceList.d.ts';
import { V1Node } from '../model/v1Node.d.ts';
import { V1NodeList } from '../model/v1NodeList.d.ts';
import { V1PersistentVolume } from '../model/v1PersistentVolume.d.ts';
import { V1PersistentVolumeClaim } from '../model/v1PersistentVolumeClaim.d.ts';
import { V1PersistentVolumeClaimList } from '../model/v1PersistentVolumeClaimList.d.ts';
import { V1PersistentVolumeList } from '../model/v1PersistentVolumeList.d.ts';
import { V1Pod } from '../model/v1Pod.d.ts';
import { V1PodList } from '../model/v1PodList.d.ts';
import { V1PodTemplate } from '../model/v1PodTemplate.d.ts';
import { V1PodTemplateList } from '../model/v1PodTemplateList.d.ts';
import { V1ReplicationController } from '../model/v1ReplicationController.d.ts';
import { V1ReplicationControllerList } from '../model/v1ReplicationControllerList.d.ts';
import { V1ResourceQuota } from '../model/v1ResourceQuota.d.ts';
import { V1ResourceQuotaList } from '../model/v1ResourceQuotaList.d.ts';
import { V1Scale } from '../model/v1Scale.d.ts';
import { V1Secret } from '../model/v1Secret.d.ts';
import { V1SecretList } from '../model/v1SecretList.d.ts';
import { V1Service } from '../model/v1Service.d.ts';
import { V1ServiceAccount } from '../model/v1ServiceAccount.d.ts';
import { V1ServiceAccountList } from '../model/v1ServiceAccountList.d.ts';
import { V1ServiceList } from '../model/v1ServiceList.d.ts';
import { V1Status } from '../model/v1Status.d.ts';
